 ...
 */
public abstract class AbstractTaskEntity<TState> implements TaskEntity {
    ...
    private static Optional<Method> findMethodUncached(Class<?> targetClass, String operationName) {
        ...
        for (Method m : targetClass.getMethods()) {
            ...
            if (m.getDeclaringClass() == AbstractTaskEntity.class) {
                continue;
            }
            // Skip methods from TaskEntity interface
