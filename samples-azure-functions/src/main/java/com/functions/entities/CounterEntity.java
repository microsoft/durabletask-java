 ...
 * <ul>
 *   <li><b>Entity dispatch</b> (class-based) — extends {@link TaskEntity} directly</li>
 *   <li><b>State dispatch</b> (POJO) — dispatches operations to the state object itself</li>
 *   <li><b>Manual dispatch</b> (low-level) — uses {@code ITaskEntity} for manual operation routing</li>
 * </ul>
 * <p>
